...
### Introduction
We are setting up the GNSS base station at initial using the budget board and make the base station to send correction messages through RFD radio modems.
